...
// refuteEvent reports whether the sink stayed silent for long enough that a
// delivery still in flight would have shown up.
...
// brokenEventsConfig keeps a usable sink ahead of one pointing at a CA file
// that does not exist, so building fails for a reason other than the extension
// being off, and only after a sink has already been opened.
